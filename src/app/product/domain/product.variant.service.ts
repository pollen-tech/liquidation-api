...
import {
    DeleteMultiProductVariantDto, DeleteProductVariantStatusDto,
    NewMultiProductVariantDto,
    NewProductVariantDto, ProductVariantDto,
...
export class ProductVariantService {
    ...
    public async multiDelete(deleteVariantDto: DeleteMultiProductVariantDto): Promise<DeleteProductVariantStatusDto[]> {
        const deleted_entities = await this.productVariantRepository.deleteAllByIds(deleteVariantDto.product_variant_ids, deleteVariantDto.user_id, deleteVariantDto.user_name)
    ...
    private async update(newDto: NewProductVariantDto) {
        ...
        return await this.productVariantRepository.save(updated_entity)
            .then(entity => {
                newDto.id = entity.id;
                return newDto;
            });
